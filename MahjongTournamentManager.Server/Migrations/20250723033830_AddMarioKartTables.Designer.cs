...
namespace MahjongTournamentManager.Server.Migrations
{
    ...
    [Migration("20250723033830_AddMarioKartTables")]
    partial class AddMarioKartTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MahjongTournamentManager.Server.Models.MahjongMatch", b =>
                {
                    ...
                    b.Property<string>("ByePlayerUserNames")
                        .HasColumnType("text");

                    b.Property<int>("Round")
                        .HasColumnType("integer");

                    b.Property<DateOnly?>("SchedulingStartDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("MahjongTournamentManager.Server.Models.MarioKartParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("MarioKartTournamentId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MarioKartTournamentId");

                    b.ToTable("MarioKartParticipants");
                });

            modelBuilder.Entity("MahjongTournamentManager.Server.Models.MarioKartTournament", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("MarioKartTournaments");
                });

            modelBuilder.Entity("MahjongTournamentManager.Server.Models.MarioKartTournamentInvitedUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("MarioKartTournamentInvitedUsers");
                });
            ...
            modelBuilder.Entity("MahjongTournamentManager.Server.Models.MahjongMatchPlayer", b =>
                {
                    b.HasOne("MahjongTournamentManager.Server.Models.MahjongMatch", "MahjongMatch")
                        .WithMany("MahjongMatchPlayers")
                        .HasForeignKey("MahjongMatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MahjongTournamentManager.Server.Models.MarioKartParticipant", b =>
                {
                    b.HasOne("MahjongTournamentManager.Server.Models.MarioKartTournament", "Tournament")
                        .WithMany("Participants")
                        .HasForeignKey("MarioKartTournamentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
