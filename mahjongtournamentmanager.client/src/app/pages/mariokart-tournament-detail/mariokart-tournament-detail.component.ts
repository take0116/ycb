...
@Component({
  selector: 'app-mariokart-tournament-detail',
  standalone: true,
  imports: [CommonModule, RouterLink, DatePipe],
  templateUrl: './mariokart-tournament-detail.component.html',
  styleUrls: ['./mariokart-tournament-detail.component.css']
})
export class MarioKartTournamentDetailComponent implements OnInit {
  ...
  editTournament(): void {
    this.router.navigate(['/mariokart-event-edit', this.tournament.id]);
  }
  ...
  share(): void {
    ...
    if (navigator.share) {
      ...
      navigator.clipboard.writeText(shareText)
        .then(() => alert('大会情報クリップボードにコピーしました。'))
