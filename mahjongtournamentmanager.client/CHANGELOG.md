...
- Create Angular project with ng: `ng new mahjongtournamentmanager.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`mahjongtournamentmanager.client.esproj`).
